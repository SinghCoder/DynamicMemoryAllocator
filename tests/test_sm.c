...
int main(int argc, char *argv[])
{
    ...
    fprintf(stderr, "after malloc p1 = %p\n", p1);

    fprintf(stderr, "before realloc p1 = %p\n", p1);
    p1 = realloc(p1, ALLOC_SIZE * 2);
    fprintf(stderr, "after realloc p1 = %p\n", p1);
    ...
    fprintf(stderr, "after malloc p2 = %p\n", p2);

    fprintf(stderr, "before free p1 = %p\n", p1);
    free(p1);
    fprintf(stderr, "after free p1 = %p\n", p1);
    fprintf(stderr, "before free p2 = %p\n", p2);
    free(p2);
    fprintf(stderr, "after free p2 = %p\n", p2);

    // p1 = calloc(5, ALLOC_SIZE);
